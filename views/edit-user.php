    ...
    <div id="main" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="endereco-residencial-estado" placeholder="Digite o estado"
                    required>
            </div>
        </div>
        <hr size="30">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="endereco-entrega-estado" placeholder="Digite o estado"
                    required>
            </div>
        </div>
        <hr size="30">
        ...
        <div id="actions" class="row">
            <div class="col-md-12">
                <button type="submit" class="btn btn-primary" onclick="submit()" id="btnAtualizar">Atualizar</button>
